        ...
        {FEATURES.COMPLY_TRACK ? (
          ...
          >
            <Link href="/training/comply-track" className="group block outline-none focus-visible:ring-2 focus-visible:ring-[var(--gold-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-matte)]">
              <div className="relative overflow-hidden rounded-lg border-2 border-[var(--gold-accent)]/45 bg-gradient-to-br from-emerald-900/28 via-[#0f2540]/95 to-[#163a5f]/40 shadow-[0_0_50px_rgba(61,165,255,0.16)] transition-all group-hover:border-[var(--gold-accent)]/70 group-hover:shadow-[0_0_60px_rgba(61,165,255,0.22)]">
